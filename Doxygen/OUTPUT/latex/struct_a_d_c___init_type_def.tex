...
\item 
uint32\+\_\+t \textbf{ Gain\+Compensation}
\item 
uint32\+\_\+t \textbf{ Scan\+Conv\+Mode}
\item 
uint32\+\_\+t \textbf{ EOCSelection}
\item 
Functional\+State \textbf{ Low\+Power\+Auto\+Wait}
\item 
Functional\+State \textbf{ Continuous\+Conv\+Mode}
\item 
uint32\+\_\+t \textbf{ Nbr\+Of\+Conversion}
\item 
Functional\+State \textbf{ Discontinuous\+Conv\+Mode}
\item 
...
\item 
uint32\+\_\+t \textbf{ Sampling\+Mode}
\item 
Functional\+State \textbf{ DMAContinuous\+Requests}
\item 
uint32\+\_\+t \textbf{ Overrun}
\item 
Functional\+State \textbf{ Oversampling\+Mode}
\item 
\textbf{ ADC\+\_\+\+Oversampling\+Type\+Def} \textbf{ Oversampling}
...
Definition at line \textbf{ 86} of file \textbf{ stm32g4xx\+\_\+hal\+\_\+adc.\+h}.
...
Definition at line \textbf{ 140} of file \textbf{ stm32g4xx\+\_\+hal\+\_\+adc.\+h}.
...
Specify ADC data alignment in conversion data register (right or left). Refer to reference manual for alignments formats versus resolutions. This parameter can be a value of \doxyref{ADC conversion data alignment}{p.}{group___a_d_c___h_a_l___e_c___d_a_t_a___a_l_i_g_n} 

Definition at line \textbf{ 102} of file \textbf{ stm32g4xx\+\_\+hal\+\_\+adc.\+h}.

\mbox{\label{struct_a_d_c___init_type_def_aa314a1478944f8457d9c9e423719d893}} 
...
Definition at line \textbf{ 150} of file \textbf{ stm32g4xx\+\_\+hal\+\_\+adc.\+h}.

\mbox{\label{struct_a_d_c___init_type_def_a535b571cac727283b16e159fe6acdcd8}} 
...
Definition at line \textbf{ 172} of file \textbf{ stm32g4xx\+\_\+hal\+\_\+adc.\+h}.
...
Specify which EOC (End Of Conversion) flag is used for conversion by polling and interruption\+: end of unitary conversion or end of sequence conversions. This parameter can be a value of \doxyref{ADC sequencer end of unitary conversion or sequence conversions}{p.}{group___a_d_c___e_o_c_selection}. 

Definition at line \textbf{ 125} of file \textbf{ stm32g4xx\+\_\+hal\+\_\+adc.\+h}.
...
Select the external event edge used to trigger ADC group regular conversion start. If trigger source is set to ADC\+\_\+\+SOFTWARE\+\_\+\+START, this parameter is discarded. This parameter can be a value of \doxyref{ADC group regular trigger edge (when external trigger is selected)}{p.}{group___a_d_c__regular__external__trigger__edge} 

Definition at line \textbf{ 165} of file \textbf{ stm32g4xx\+\_\+hal\+\_\+adc.\+h}.

\mbox{\label{struct_a_d_c___init_type_def_a6cd3a58fd63fa24afc202d8e62baf84e}} 
...
\doxysubsubsection{GainCompensation}
...
Definition at line \textbf{ 106} of file \textbf{ stm32g4xx\+\_\+hal\+\_\+adc.\+h}.

\mbox{\label{struct_a_d_c___init_type_def_a17f2a28967e1ad48b687c1a670f567b7}} 
...
Definition at line \textbf{ 144} of file \textbf{ stm32g4xx\+\_\+hal\+\_\+adc.\+h}.
...
Definition at line \textbf{ 156} of file \textbf{ stm32g4xx\+\_\+hal\+\_\+adc.\+h}.

\mbox{\label{struct_a_d_c___init_type_def_ac20c5da6d0ffd3de9c705eff0f5a13bc}} 
\index{ADC\_InitTypeDef@{ADC\_InitTypeDef}!Overrun@{Overrun}}
\index{Overrun@{Overrun}!ADC\_InitTypeDef@{ADC\_InitTypeDef}}
\doxysubsubsection{Overrun}
{\footnotesize\ttfamily uint32\+\_\+t Overrun}

Select the behavior in case of overrun\+: data overwritten or preserved (default). This parameter applies to ADC group regular only. This parameter can be a value of \doxyref{ADC group regular -\/ Overrun behavior on conversion data}{p.}{group___a_d_c___h_a_l___e_c___r_e_g___o_v_r___d_a_t_a___b_e_h_a_v_i_o_r}. Note\+: In case of overrun set to data preserved and usage with programming model with interruption (HAL\+\_\+\+Start\+\_\+\+IT())\+: ADC IRQ handler has to clear end of conversion flags, this induces the release of the preserved data. If needed, this data can be saved in function HAL\+\_\+\+ADC\+\_\+\+Conv\+Cplt\+Callback(), placed in user program code (called before end of conversion flags clear). Note\+: Error reporting with respect to the conversion mode\+:
\begin{DoxyItemize}
...
Definition at line \textbf{ 177} of file \textbf{ stm32g4xx\+\_\+hal\+\_\+adc.\+h}.

\mbox{\label{struct_a_d_c___init_type_def_ac56060c128320b1fa8f7a505e42183cc}} 
...
{\footnotesize\ttfamily \textbf{ ADC\+\_\+\+Oversampling\+Type\+Def} Oversampling}
...
Definition at line \textbf{ 192} of file \textbf{ stm32g4xx\+\_\+hal\+\_\+adc.\+h}.

\mbox{\label{struct_a_d_c___init_type_def_a9f2cda697b30bc6c4d4fcd1eccd8c3cd}} 
...
\doxysubsubsection{OversamplingMode}
...
Definition at line \textbf{ 188} of file \textbf{ stm32g4xx\+\_\+hal\+\_\+adc.\+h}.
...
Configure the ADC resolution. This parameter can be a value of \doxyref{ADC instance -\/ Resolution}{p.}{group___a_d_c___h_a_l___e_c___r_e_s_o_l_u_t_i_o_n} 

Definition at line \textbf{ 99} of file \textbf{ stm32g4xx\+\_\+hal\+\_\+adc.\+h}.

\mbox{\label{struct_a_d_c___init_type_def_aff396fea3dc52bebfa4a30d7fcaf3a6f}} 
...
\doxysubsubsection{SamplingMode}
{\footnotesize\ttfamily uint32\+\_\+t Sampling\+Mode}

Select the sampling mode to be used for ADC group regular conversion. This parameter can be a value of \doxyref{ADC group regular sampling mode}{p.}{group___a_d_c__regular__sampling__mode} 

Definition at line \textbf{ 169} of file \textbf{ stm32g4xx\+\_\+hal\+\_\+adc.\+h}.
